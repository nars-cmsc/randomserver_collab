...
<body>
  ...
  <div class="col-md-6">
    <h2 class="form-header"> List of Passed Courses </h2>
            ...
            while ($rows = mysqli_fetch_assoc($result)) {?>
              <tr>
                <td>
                  ...
                  <td><?php echo $rows['COURSE_NUM'];?></td>
                  <td><?php echo $rows['TERM_TAKEN']; ?></td>
                  <td><?php echo $rows['STATUS']; ?></td>
                  <td><?php echo $rows['GRADE']; ?></td>
                  <td align="center"><?php echo $rows['TO_COMPUTE']; ?></td>
                  <!-- jen -->
                <td><a href="editcourse.php?coursenum=<?php echo $rows['COURSE_NUM']; ?>">Edit</a></td> 
              </tr>	
    ...
    <div class="form_group">
      <button type="button" class="btn btn-danger" type="submit" name="delete" value="Delete">Delete</button>
    </div>
